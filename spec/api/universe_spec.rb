...
describe 'GET /universe' do
  ...
  it 'returns https URLs when necessary' do
    ...
    expect(response).to be_success
    expect(json_body['redis']['1.2.0']['location_path']).to match(%r{https.*/api/v1/cookbooks/redis/versions/1_2_0/download})
  end
  ...
  it 'lists out cookbooks, their versions, and dependencies' do
    ...
    expect(body['redis']['1.2.0']['location_path']).to match(%r{/api/v1/cookbooks/redis/versions/1_2_0/download})
    ...
    expect(body['redis']['1.3.0']['location_path']).to match(%r{/api/v1/cookbooks/redis/versions/1_3_0/download})
