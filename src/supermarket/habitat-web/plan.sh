...
scaffolding_env[ENABLE_GTAG]="{{ cfg.app.enable_gtag_flag }}"
scaffolding_env[ENABLE_GTM]="{{ cfg.app.enable_gtm_flag }}"
scaffolding_env[ENABLE_ONETRUST]="{{ cfg.app.enable_onetrust_flag }}"
...
scaffolding_env[GTM_ID]="{{ cfg.app.gtm_id }}"
